...
const hexagrams = {
  ...
  101110: { name: "鼎", number: 50, palace: 3, type: 3 }, // 修改编号为50
  101010: { name: "未濟", number: 64, palace: 3, type: 4 }, // 修改编号为64
  100010: { name: "蒙", number: 4, palace: 3, type: 5 }, // 修改编号为4
  110010: { name: "渙", number: 59, palace: 3, type: 6 }, // 修改编号为59
  111010: { name: "訟", number: 6, palace: 3, type: 7 }, // 修改编号为6
  111101: { name: "同人", number: 13, palace: 3, type: 8 }, // 修改编号为13
...
const PALACE_NAJIA_RULES = {
  ...
  5: {
    ...
    outer: {
      stem: "辛",
      branches: [branchMap["未"], branchMap["已"], branchMap["卯"]],
    },
  },
  6: {
    // 坎宮：坎內戊寅外戊申
...
const najiaInfo = getHexagramNajia("011101"); // 取得乾卦納甲信息
